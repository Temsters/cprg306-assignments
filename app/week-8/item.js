...
export default function Item({ name, quantity, category, bgColor, onSelect }) {
  return (
    <div onClick={onSelect} className={`cursor-pointer hover:scale-105 transition-transform duration-200 my-2 max-w-sm p-2 rounded-lg mx-auto text-center shadow-md ${bgColor} dark:border-white`}>
